...
typedef void(^RedPreLoadCallback)(const RedPreLoadTask task, RedPreLoadControllerMsgType msgType, void* userData);
...
/// Initialize preload with cache path, maximum size, and maximum directory capacity
