...
class RedTabBarController: UIViewController {
    ...
    private func setupNavigationBar() {
        ...
        let textWidth = title.size(withAttributes: textAttributes).width
        let gap = 10.0
//        let titleView = UIView(frame: CGRect(x: 0, y: 0, width: textWidth + gap + 44.0, height: 44.0))
//
...
//
//        let titleLabel = UILabel(frame: CGRect(x: 44.0 + gap, y: 0, width: textWidth, height: 44.0))
//        titleLabel.text = "RedPlayer"
//        titleLabel.font = UIFont.boldSystemFont(ofSize: 20)
//        titleLabel.textAlignment = .left
//        titleView.addSubview(titleLabel)
        
        let titleView = UIView(frame: CGRect(x: 0, y: 0, width: textWidth, height: 44.0))

        let titleLabel = UILabel(frame: CGRect(x: 0, y: 0, width: textWidth, height: 44.0))
        titleLabel.text = "RedPlayer"
        titleLabel.font = UIFont.boldSystemFont(ofSize: 20)
        titleLabel.textAlignment = .left
        titleView.addSubview(titleLabel)
