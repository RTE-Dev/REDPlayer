...
public class XhsProgressBar extends View {
    ...
    private XhsProgressBuilder mConfigBuilder; // config attributes
    ...
    public XhsProgressBar(Context context) {
        this(context, null);
    }

    public XhsProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XhsProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XhsProgressBar, defStyleAttr, 0);
        mMin = a.getFloat(R.styleable.XhsProgressBar_ssb_min, 0.0f);
        mMax = a.getFloat(R.styleable.XhsProgressBar_ssb_max, 100.0f);
        mProgress = a.getFloat(R.styleable.XhsProgressBar_ssb_progress, mMin);
        isFloatType = a.getBoolean(R.styleable.XhsProgressBar_ssb_is_float_type, false);
        mTrackSize = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_track_size, XhsProgressUtils.dp2px(3));
        mTextSpace = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_text_space, XhsProgressUtils.dp2px(3));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_second_track_size, mTrackSize);
        mThumbRadius = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_thumb_radius, mSecondTrackSize + XhsProgressUtils.dp2px(3));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_thumb_radius, mSecondTrackSize * 2);
        mSignBorderSize = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_border_size, XhsProgressUtils.dp2px(1));
        mSectionCount = a.getInteger(R.styleable.XhsProgressBar_ssb_section_count, 6);
        mTrackColor = a.getColor(R.styleable.XhsProgressBar_ssb_track_color, ContextCompat.getColor(context, R.color.white));
        mSecondTrackColor = a.getColor(R.styleable.XhsProgressBar_ssb_second_track_color, ContextCompat.getColor(context, R.color.gray));
        mThumbColor = a.getColor(R.styleable.XhsProgressBar_ssb_thumb_color, mSecondTrackColor);
        isShowSectionText = a.getBoolean(R.styleable.XhsProgressBar_ssb_show_section_text, false);
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_section_text_size, XhsProgressUtils.sp2px(14));
        mSectionTextColor = a.getColor(R.styleable.XhsProgressBar_ssb_section_text_color, mTrackColor);
        isSeekBySection = a.getBoolean(R.styleable.XhsProgressBar_ssb_seek_by_section, false);
        int pos = a.getInteger(R.styleable.XhsProgressBar_ssb_section_text_position, NONE);
        if (pos == 0) {
        ...
        mSectionTextInterval = a.getInteger(R.styleable.XhsProgressBar_ssb_section_text_interval, 1);
        isShowThumbText = a.getBoolean(R.styleable.XhsProgressBar_ssb_show_thumb_text, false);
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_thumb_text_size, XhsProgressUtils.sp2px(14));
        mThumbTextColor = a.getColor(R.styleable.XhsProgressBar_ssb_thumb_text_color, mSecondTrackColor);
        mSignColor = a.getColor(R.styleable.XhsProgressBar_ssb_sign_color, mSecondTrackColor);
        mSignBorderColor = a.getColor(R.styleable.XhsProgressBar_ssb_sign_border_color, mSecondTrackColor);
        mUnusableColor = a.getColor(R.styleable.XhsProgressBar_ssb_unusable_color, Color.GRAY);
        mSignTextSize = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_text_size, XhsProgressUtils.sp2px(14));
        mSignHeight = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_height, XhsProgressUtils.dp2px(32));
        mSignWidth = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_width, XhsProgressUtils.dp2px(72));
        mSignArrowHeight = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_arrow_height, XhsProgressUtils.dp2px(3));
        mSignArrowWidth = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_arrow_width, XhsProgressUtils.dp2px(5));
        mSignRound = a.getDimensionPixelSize(R.styleable.XhsProgressBar_ssb_sign_round, XhsProgressUtils.dp2px(3));
        mSignTextColor = a.getColor(R.styleable.XhsProgressBar_ssb_sign_text_color, Color.WHITE);
        isShowSectionMark = a.getBoolean(R.styleable.XhsProgressBar_ssb_show_section_mark, false);
        isAutoAdjustSectionMark = a.getBoolean(R.styleable.XhsProgressBar_ssb_auto_adjust_section_mark, false);
        isShowProgressInFloat = a.getBoolean(R.styleable.XhsProgressBar_ssb_show_progress_in_float, false);
        int duration = a.getInteger(R.styleable.XhsProgressBar_ssb_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        isTouchToSeek = a.getBoolean(R.styleable.XhsProgressBar_ssb_touch_to_seek, false);
        isShowSignBorder = a.getBoolean(R.styleable.XhsProgressBar_ssb_sign_show_border, false);

        int labelsResId = a.getResourceId(R.styleable.XhsProgressBar_ssb_sides_labels, 0);
        mThumbBgAlpha = a.getFloat(R.styleable.XhsProgressBar_ssb_thumb_bg_alpha, 0.2f);
        mThumbRatio = a.getFloat(R.styleable.XhsProgressBar_ssb_thumb_ratio, 0.7f);
        isShowThumbShadow = a.getBoolean(R.styleable.XhsProgressBar_ssb_show_thumb_shadow, false);
        isShowSign = a.getBoolean(R.styleable.XhsProgressBar_ssb_show_sign, false);
        isSignArrowAutofloat = a.getBoolean(R.styleable.XhsProgressBar_ssb_sign_arrow_autofloat, true);
        a.recycle();
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + XhsProgressUtils.dp2px(2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + XhsProgressUtils.dp2px(2);
        }
    ...
    private void drawMark(Canvas canvas, float xLeft, float yTop, boolean isShowTextBelowSectionMark, boolean conditionInterval) {
        float r = (mThumbRadiusOnDragging - XhsProgressUtils.dp2px(2)) / 2f;
                    ...
                    animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    if (mProgressListener != null) {
                                        mProgressListener.onProgressChanged(XhsProgressBar.this,
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(XhsProgressBar.this, getProgress(), getProgressFloat(), true);
                    }
                }
            });
        }
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(XhsProgressBar.this, getProgress(), getProgressFloat(), true);
                }
            }
    ...
    void config(XhsProgressBuilder builder) {
        mMin = builder.min;
        mMax = builder.max;
    ...
    public XhsProgressBuilder getConfigBuilder() {
        if (mConfigBuilder == null) {
            mConfigBuilder = new XhsProgressBuilder(this);
        }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(XhsProgressBar XhsProgressBar, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(XhsProgressBar XhsProgressBar, int progress, float progressFloat);

        void getProgressOnFinally(XhsProgressBar XhsProgressBar, int progress, float progressFloat, boolean fromUser);
    }
